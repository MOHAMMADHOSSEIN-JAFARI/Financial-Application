...
ui <- fluidPage(
  titlePanel(h1("Wellcome to Financial Tablet")),
  
  sidebarLayout(
    sidebarPanel(
      helpText("The candlestic chart shows the price and the chosen financial indicator of Microsoft Co. during the chosen period"),
      
      
      selectInput("var", 
                  label = "Choose the type of indicator you want to be shown",
                  choices = c("MACD", 
                              "RSI",
                              "EMA"),
                  selected = "RSI"),
